        ...
        <div class="container">
            ...
            <div class="signin-right " id="a-sign">
                <form action="/login" method="post">
                    ...
                    <div class="submit">
                        <button class="btn" type="submit" style="background: darkseagreen; color: black">ĐĂNG NHẬP</button>
                        <div class="forgetpassword">
                            <a id="quenmk">Quên mật khẩu?</a> <a href="/register">Đăng kí</a>
                        </div>
            ...
            <div class="signin-right " id="b-sign">
                <form action="">
                    ...
                    <div class="password form-control1">
                        <input type="text" id="password1" placeholder="Mật khẩu">
                    </div>
