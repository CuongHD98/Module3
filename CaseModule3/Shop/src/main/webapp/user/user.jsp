  ...
  <div class="container">
    ...
    <div class="desk-menu collapse navbar-collapse justify-content-md-center" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/userproduct">BỘ SƯU TẬP</a>
        </li>
        <li class="nav-item">
        ...
        <div class="site-nav-container-last" style="color:#272727">
          <div class="cart-view clearfix">
            ...
            <table class="table-total">
              ...
              <tr>
                <td><a href="viewcartSignin.html" class="linktocheckout btn btn-success" style="color: white">Thanh
                  toán</a></td>
              </tr>
              </tbody>
            </table>
        ...
        <div class="product-block">
          <div class="product-img fade-box">
            <a href="#" title="Adidas EQT Cushion ADV" class="img-resize">
              <img src="/images/shoes/801740_1_e4adfa6d09b7468a8c9fb21bf8e02bd4_medium%20(1).jpg"
                   alt="Adidas EQT Cushion ADV" class="lazyloaded">
              <img src="/images/shoes/shoes%20fade%201.jpg" alt="Adidas EQT Cushion ADV" class="lazyloaded">
            </a>
              ...
              <div class="product-img fade-box">
                <a href="#" title="Adidas Ultraboost W" class="img-resize">
                  <img src="/images/shoes/801432_01_b16d089f8bda434bacfe4620e8480be1_grande.jpg"
                       ...
                       class="lazyloaded">
                  <img src="/images/shoes/shoes%20fade%204.jpg" alt="Adidas Ultraboost W"
                       class="lazyloaded">
                </a>
