                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Blog</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/blogcreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewBlog <i
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${blog.image_id}"/></td>
                                            <td><c:out value="${blog.title}"/></td>
                                            <td><c:out value="${blog.content}"/></td>
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/blog?action=edit&id=${blog.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/blog?action=delete&id=${blog.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/blog?action=edit&id=${blog.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="image_id" class="bmd-label-floating">Image_ID</label>
                                            <input type="text" class="form-control" id="image_id" name="image_id" value="${blog.image_id}">
                                        </div>
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/blog" class="btn btn-info" role="button">Close</a>
