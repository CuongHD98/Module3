                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" href="/admin/shoedetail?action=create"
                        ...
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Create ShoeDetail</h4>
                                </div>
                                <form action="/admin/shoedetail?action=create" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="shoe_id" name="shoe_id" value="">
                                        </div>
                                        <div>
                                            <label for="color_id" class="bmd-label-floating">Color_ID</label>
                                            <input type="text" class="form-control" id="color_id" name="color_id" value="">
                                        </div>
                                        <div>
                                            <label for="size_id" class="bmd-label-floating">Size_ID</label>
                                            <input type="text" class="form-control" id="size_id" name="size_id" value="">
                                        </div>
                                        <div>
