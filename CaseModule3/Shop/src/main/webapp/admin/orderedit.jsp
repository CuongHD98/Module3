                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" onclick="RenderActions('/admin/ordercreate.jsp')"
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/order?action=edit&id=${order.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" class="form-control" id="status_id" name="status_id" value="${order.status_id}">
                                        </div>
                                    </div>
