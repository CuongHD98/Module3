                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Status</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/statuscreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewStatus <i
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/status?action=edit&id=${status.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/status?action=delete&id=${status.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/status?action=edit&id=${status.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <input id="Id" name="id" type="hidden" value="${status.id}">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/status" class="btn btn-info" role="button">Close</a>
