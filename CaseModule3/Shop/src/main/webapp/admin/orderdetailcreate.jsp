                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" href="/admin/orderdetail?action=create"
                        ...
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Create OrderDetail</h4>
                                </div>
                                <form action="/admin/orderdetail?action=create" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="shoedetail_id" name="shoedetail_id" value="">
                                        </div>
                                        <div>
                                            <label for="quantity_buy" class="bmd-label-floating">Quantity_BUY</label>
                                            <input type="text" class="form-control" id="quantity_buy" name="quantity_buy" value="">
                                        </div>
                                    </div>
