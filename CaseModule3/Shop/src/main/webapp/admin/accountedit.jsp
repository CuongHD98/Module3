                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" onclick="RenderActions('/admin/accountcreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewAccount <i
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td class="disabled-sorting text-right">
                                                <a href="/account?action=edit&id=${account.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/account?action=delete&id=${account.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/account?action=edit&id=${account.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input class="form-control" type="text" name="birthday" value="${account.birthday}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/account" class="btn btn-info" role="button">Close</a>
