                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Size</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/sizecreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewSize <i
                            ...
                            <div class="card-body">
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><c:out value="${size.id}"/></td>
                                            <td><c:out value="${size.size}"/></td>
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/size?action=edit&id=${size.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/size?action=delete&id=${size.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/size?action=edit&id=${size.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <input id="Id" name="id" type="hidden" value="${size.id}">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/size" class="btn btn-info" role="button">Close</a>
