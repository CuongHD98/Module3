                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD OrderDetail</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/orderdetailcreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewOrderDetail <i
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${orderDetail.shoedetail_id}"/></td>
                                            <td><c:out value="${orderDetail.quantity_buy}"/></td>
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/orderdetail?action=edit&id=${orderDetail.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/orderdetail?action=delete&id=${orderDetail.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Edit OrderDetail</h4>
                                </div>
                                <form action="/admin/orderdetail?action=edit&id=${orderdetail.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <input id="Id" name="id" type="hidden" value="${orderdetail.id}">
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="order_id" class="bmd-label-floating">Order_ID</label>
                                            <input type="text" class="form-control" id="order_id" name="order_id" value="${orderdetail.order_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="shoedetail_id" class="bmd-label-floating">ShoeDetail_ID</label>
                                            <input type="text" class="form-control" id="shoedetail_id" name="shoedetail_id" value="${orderdetail.shoedetail_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="quantity_buy" class="bmd-label-floating">Quantity_BUY</label>
                                            <input type="text" class="form-control" id="quantity_buy" name="quantity_buy" value="${orderdetail.quantity_buy}">
                                        </div>
                                    </div>
                                    <div class="card-footer ">
                                        <a href="/admin/orderdetail" class="btn btn-info" role="button">Close</a>
