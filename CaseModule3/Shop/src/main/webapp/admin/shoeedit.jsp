                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Shoe</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/shoecreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewShoe <i
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${shoe.image_id}"/></td>
                        ...
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Edit Shoe</h4>
                                </div>
                                <form action="/admin/shoe?action=edit&id=${shoe.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" class="form-control" id="image_id" name="image_id" value="${shoe.image_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                        ...
                                        <div class="form-group bmd-form-group is-filled">
                                            ...
                                            <input type="text" class="form-control" id="description" name="description" value="${shoe.description}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/shoe" class="btn btn-info" role="button">Close</a>
