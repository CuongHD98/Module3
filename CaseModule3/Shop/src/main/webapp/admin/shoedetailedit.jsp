                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD ShoeDetail</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/shoedetailcreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewShoeDetail <i
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${shoedetail.color_id}"/></td>
                                            <td><c:out value="${shoedetail.size_id}"/></td>
                                            <td><c:out value="${shoedetail.quantity}"/></td>
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/shoedetail?action=edit&id=${shoedetail.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/shoedetail?action=delete&id=${shoedetail.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Edit ShoeDetail</h4>
                                </div>
                                <form action="/admin/shoedetail?action=edit&id=${shoedetail.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                        ...
                                        <input id="Id" name="id" type="hidden" value="${shoedetail.id}">
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="shoe_id" class="bmd-label-floating">Shoe_ID</label>
                                            <input type="text" class="form-control" id="shoe_id" name="shoe_id" value="${shoedetail.shoe_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="color_id" class="bmd-label-floating">Color_ID</label>
                                            <input type="text" class="form-control" id="color_id" name="color_id" value="${shoedetail.color_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="size_id" class="bmd-label-floating">Size_ID</label>
                                            <input type="text" class="form-control" id="size_id" name="size_id" value="${shoedetail.size_id}">
                                        </div>
                                        <div class="form-group bmd-form-group is-filled">
                                            <label for="quantity" class="bmd-label-floating">Quantity</label>
                                            <input type="text" class="form-control" id="quantity" name="quantity" value="${shoedetail.quantity}">
                                        </div>
                                    </div>
                                    <div class="card-footer ">
                                        <a href="/admin/shoedetail" class="btn btn-info" role="button">Close</a>
