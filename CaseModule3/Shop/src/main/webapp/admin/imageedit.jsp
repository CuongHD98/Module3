                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Image</h4>
                                <a data-toggle="modal" onclick="RenderActions('/admin/imagecreate.jsp')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewImage <i
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/image?action=edit&id=${image.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/image" class="btn btn-info" role="button">Close</a>
