                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" href="/admin/account?action=create"
                                        ...
                                        <c:forEach var="account" items="${listAccount}">
                                            <tr>
                                                ...
                                                <td class="disabled-sorting text-right">
                                                    <a href="/admin/account?action=edit&id=${account.id}" class="btn btn-info" role="button">Edit</a>
                                                    <a href="/admin/account?action=delete&id=${account.id}" class="btn btn-info" role="button">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/account?action=create" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
