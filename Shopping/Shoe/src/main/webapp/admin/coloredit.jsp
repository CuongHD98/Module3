                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Colors</h4>
                                <a data-toggle="modal" onclick="RenderActions('/Users/CreateUser')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewColor <i
                                ...
                                <div class="material-datatables table-responsive table">
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${color.code}"/></td>
                                            <td><div style="background-color: ${color.code};width: 50px; height: 30px"></div></td>
                                            <td class="disabled-sorting text-right">
                                                <a href="/admin/color?action=edit&id=${color.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/admin/color?action=delete&id=${color.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/color?action=edit&id=${color.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/color" class="btn btn-info" role="button">Close</a>
