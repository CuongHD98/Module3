...
<head>
    ...
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no'
          name='viewport'/>
    <meta name="keywords"
          content="Material Design, html dashboard, html css dashboard, web dashboard, bootstrap 4 dashboard, bootstrap 4, css3 dashboard, bootstrap 4 admin, material dashboard bootstrap 4 dashboard, frontend, responsive bootstrap 4 dashboard, material design, material dashboard bootstrap 4 dashboard">
...
<div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="/admin/assets/img/sidebar-1.jpg">
        <div class="logo">
            <a href="index.html" class="btn btn-info container" role="button">SHOE SHOP</a>
        </div>
                        ...
                        <ul class="nav">
                            <li class="nav-item ">
                                <a class="nav-link" href="/admin/color">
                                    ...
                                    <span class="sidebar-normal"> COLORS Manager </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="nav">
                            <li class="nav-item ">
                                <a class="nav-link" href="/admin/size">
                                    ...
                                    <span class="sidebar-normal"> SIZES Manager </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                ...
                                <a class="dropdown-item" target="_blank"
                                   href="Identity/Account/Register.html">Register</a>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <h4 class="card-title">CRUD Users</h4>
                                <a data-toggle="modal" onclick="RenderActions('/Users/CreateUser')"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create New <i
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <td class="disabled-sorting text-right">
                                                <a href="/users?action=edit&id=${user.id}" class="btn btn-info" role="button">Edit</a>
                                                <a href="/users?action=delete&id=${user.id}" class="btn btn-info" role="button">Delete</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/user?action=edit&id=${user.id}" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-md-8 form-group ">
                                            ...
                                            <select id="GenderId" class="form-control" data-val="true" data-val-required="The GenderId field is required." name="gender"><option value="Male">Male</option>
                                    ...
                                    </div><div class="form-group bmd-form-group is-filled">
                                    ...
                                    <div class="card-footer ">
                                        <a href="/admin/user" class="btn btn-info" role="button">Close</a>
                                        <button class="btn btn-fill btn-rose pull-right" type="submit">Save</button>
                                    </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="copyright float-right">
                    ...
                    <a href="index.html" target="_blank">CuongHD</a> for a better web.
                </div>
            </div>
        </footer>
    </div>
    ...
    <div class="dropdown show-dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="button-container">
                <a href="https://codecanyon.net/item/material-dashboard-net-core-admin-template-crud/23834228"
                   target="_blank" class="btn btn-rose btn-block btn-fill">Buy Now</a>
                <a href="Helps/docs/2.2/getting-started/introduction.html" target="_blank"
                   class="btn btn-default btn-block">
                    Documentation
                </a>
                <a href="index.html" target="_blank" class="btn btn-info btn-block">
                    Get Free Demo!
                </a>
            </li>
