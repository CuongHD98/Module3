                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-primary card-header-icon">
                                ...
                                <a data-toggle="modal" href="/admin/user?action=create"
                                   data-target="#modalUser" class="pull-right btn btn-success">Create NewUser <i
                                        ...
                                        <c:forEach var="user" items="${listUser}">
                                            <tr>
                                                ...
                                                <td class="disabled-sorting text-right">
                                                    <a href="/admin/user?action=edit&id=${user.id}" class="btn btn-info" role="button">Edit</a>
                                                    <a href="/admin/user?action=delete&id=${user.id}" class="btn btn-info" role="button">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                    ...
                    <div class="modal-content">
                        <div id="OpenDialog" class="modal-body">
                            <div class="card ">
                                ...
                                <form action="/admin/user?action=create" class="form-horizontal"  id="FormProCreate" method="post">
                                    <div class="card-body ">
